...
import type { InterfaceSchema, ProviderMetadata, SkappInfo } from ".";
...
export abstract class Provider<T> {
  ...
  constructor(providerInterface: InterfaceSchema, metadata: ProviderMetadata) {
   ...
   */
  protected async connectSilently(skappInfo: SkappInfo): Promise<InterfaceSchema | null> {
